...
verification_scope: "Unity 6000.4.0f1: 배경 헬기 visualScale 0.9→1.35(1.5배). 실제 1280×720 투영 66.6~91.8×39.4~52.2px, 4대·개틀링 167회·트레이서 3발·추락·기수/이동 최소 내적 0.903·전투 불변식 통과. 공중·지상 공용 집중 EditMode 10/10. 직전 전체 115/115 유지; 신규 전체 MCP 작업은 92/115에서 포커스 중단으로 미확정."
...
| 표시 크기 | `visualScale=1.35`(이전 0.9의 1.5배), 1280×720에서 약 66.6~91.8×39.4~52.2px |
...
2026-08-31에는 배경 헬기 루트 스케일을 0.9에서 1.35로 정확히 1.5배 확대했다. 기존 씬 값에만 적용되는 authored configuration v10 마이그레이션을 사용하며 Builder 재실행 후에도 1.35를 유지한다. 실제 Play 검증에서 네 기체 모두 localScale 1.35, 투영 폭 66.6~91.8px, 개틀링·가짜 공격·추락·복귀와 전투 불변식이 유지됐다.
