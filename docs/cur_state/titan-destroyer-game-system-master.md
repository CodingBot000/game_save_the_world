...
implementation_baseline: "git fae4fdf + 2026-08-01 gatling base damage 3 verified working tree"
...
| ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 1.00초 | 5 | 30% | 9 | 1.8 |
| 2 | 2.50초 | 10 | 40% | 12 | 1.2 |
| 3 | 4.50초 | 15 | 50% | 15 | 1 |
| 4 | 7.00초 | 20 | 60% | 18 | 0.9 |
| 5 | 10.00초 | 30 | 100% | 30 | 1 |
...
- Git 기준점: `fae4fdf` 및 현재 미커밋 `BattleArena` 작업 트리
- Unity 버전: `6000.4.0f1`
...
- 개틀링 기본 1발 피해를 3으로 낮춘 뒤 Play Mode 런타임 `CurrentGatlingBaseDamage=3`과 락온 단계별 총 기본 피해 `9/12/15/18/30`을 확인했다.
